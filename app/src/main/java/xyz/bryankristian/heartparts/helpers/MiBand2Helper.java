package xyz.bryankristian.heartparts.helpers;
...
public class MiBand2Helper {
    public static final String TAG = "MI_BAND_HELPER";
    ...
    private  MiBand2Helper() {}

    public MiBand2Helper(Context context, android.os.Handler handler) {
        myContext = context;
        myHandler = handler;
    }
